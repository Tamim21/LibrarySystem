...
public class DeleteLibrarian extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(ar.removeLibrarian(s)) {JOptionPane.showMessageDialog(null, "The Librarian with id = "+ s +"has been deleted");
        dispose();
        AM am = new AM();
        am.setVisible(true);
    }
        else JOptionPane.showMessageDialog(null, "The Librarian with id = "+ s +"doesn't exist");
        jTextField1.setText("");
