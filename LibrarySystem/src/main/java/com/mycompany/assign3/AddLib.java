...
public class AddLib extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String ID,Name,Email,Address,Number;
        ...
        JOptionPane.showMessageDialog(null, "Some fields are empty");
            ...
            Address = this.jTextField4.getText();
            Number = this.jTextField5.getText();
            AdminRole ar = new AdminRole();
            if(ar.addLibrarian(ID, Name, Email, Address, Number)==true)
            {JOptionPane.showMessageDialog(null, "Librarian added succesfully");
                AM am = new AM();
                dispose();
                am.setVisible(true);
            }
            else  {JOptionPane.showMessageDialog(null, "The Librarian already exists");
            }
            jTextField1.setText("");
            jTextField2.setText("");
            jTextField3.setText("");
